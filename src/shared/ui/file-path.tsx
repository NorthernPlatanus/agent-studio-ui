 ...
 * `run-timeline/ui/RunTimeline.tsx`, `run-timeline/lib/timeline.ts` and
 * `run-timeline/config.ts` — all rendered as the identical string
 * `src/features/run-time…`. Three different files, one visible label.
 *
